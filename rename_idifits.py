...
'epoch_data' directory.
eg. output name: <obscode><epoch><idikey><band><.idifits>, where band is equal to 0/1
    Generally, it will be zero, except for the dual band observation like BD174.
    BD174A1IBC10.idifits
"""
